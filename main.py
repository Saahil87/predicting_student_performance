...
def results():
    if request.method == 'POST':
        ...
        a = [a1, a2, ','.join(a3), a4, a5, a6, a7, a8, a9, a10, a11, a12, a13, a14, a15, a16, a17, a18, a19, a20, a21,
             a22]
        X = pd.DataFrame(a)
        X = X.transpose()
        ...
        return render_template("results.html", a1=a1, a2=a2, a3=a3, a4=a4, a5=a5, a6=a6, a7=a7, a8=a8, a9=a9, a10=a10,
                               a11=a11, a12=a12, a13=a13, a14=a14, a15=a15, a16=a16, a17=a17, a18=a18, a19=a19, a20=a20,
                               a21=a21, a22=a22, y_pred=y_pred, y_pred1=y_pred1, s1=s1)
